...
CORS(clients, origins=['http://localhost:3000', 'https://kelper.herokuapp.com'] , supports_credentials=True)
CORS(users, origins=['http://localhost:3000', 'https://kelper.herokuapp.com'], supports_credentials=True)
CORS(incidents, origins=['http://localhost:3000', 'https://kelper.herokuapp.com'], supports_credentials=True)
CORS(messages, origins=['http://localhost:3000', 'https://kelper.herokuapp.com'], supports_credentials=True)
